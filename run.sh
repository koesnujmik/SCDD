...
# ============================================================================
# CIFAR-10 RLDD pipeline.
#
# Layout: experiments/${EXP_NAME}/{experts,initials,recovers,students}/
#   - All artifact ids (expert_NNN, baseline_NNN, init_NNN, baseline_init_NNN,
#     recover_NNN, student_NNN) are atomically allocated by tools/exp_layout.sh.
#   - Each artifact dir gets metadata.json (lineage) and args.json (hyperparams).
#   - registry.csv at experiments/${EXP_NAME}/ tracks every artifact run.
# ============================================================================
...
DATASET_TAG="cifar10_IF${IF_VALUE}"
