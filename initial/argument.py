...
parser.add_argument(
    ...
    type=str,
    default="original",
    choices=["original", "entropy_low", "entropy_high", "center", "kmeans", "shrinkage_kmeans"],
    help="method for selecting representative images: "
         "original (confidence), entropy_low, kmeans",
)
"""Re Train"""
