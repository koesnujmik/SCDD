...
def get_dataset(args):
    ...
    if args.dataset == 'tiny':
        trainset = tinyImbalance.TinyImbanlance(transform=util.TwoCropTransform(transform_train),imbanlance_rate=args.imbanlance_rate, train=True,file_path=os.path.join(args.root,'tiny-imagenet-200/'))
    ...
    if args.dataset == 'ImageNet-LT':
        trainset = dataset_lt_data.LT_Dataset(os.path.join(args.root,'imagenet/'), args.dir_train_txt,util.TwoCropTransform(transform_train))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet34',choices=('convnet','convnet4','convnet5','resnet18', 'resnet32', 'resnet34', 'resnet50', 'resnext50_32x4d'))
